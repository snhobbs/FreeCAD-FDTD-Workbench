...
class ExcitationSettingsItem(SettingsItem):
    def __init__(self, name="", type="", sinusodial=None, gaussian=None, custom=None, dirac=None, step=None, units = "Hz", priority=0):
        super().__init__(name=name, type=type, priority=priority)
