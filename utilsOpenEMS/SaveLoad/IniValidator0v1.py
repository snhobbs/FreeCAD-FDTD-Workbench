...
class IniValidator0v1:
        ...
        "topLevelGroups": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    },
                    {
                        ...
                        "mandatory": False,
                        "allowedValues": {
                            "x": {"mandatory": True, "allowedValues": "float"},
                            "y": {"mandatory": True, "allowedValues": "float"},
                            "z": {"mandatory": True, "allowedValues": "float"},
                            "units": {
                                "mandatory": True,
                                "allowedValues": r"(pm|nm|um|mm|cm|m|km)",
                            },
                    ...
                    {"name": "xenabled", "mandatory": True, "allowedValues": "bool"},
                    {"name": "yenabled", "mandatory": True, "allowedValues": "bool"},
                    {"name": "zenabled", "mandatory": True, "allowedValues": "bool"},
                    {
                        "name": "fixedDistance",
                    ...
                    },
                    {
                        ...
                        "allowedValues": {
                            "xMaxRes": {"mandatory": True, "allowedValues": "float"},
                            "yMaxRes": {"mandatory": True, "allowedValues": "float"},
                            "zMaxRes": {"mandatory": True, "allowedValues": "float"},
                        },
                    },
                ],
            },
            {
                ...
                "items": [
                    ...
                    {"name": "isActive", "mandatory": True, "allowedValues": "bool"},
                    {
            ...
            },
            {
                ...
                "items": [
                    ...
                    },
                    {
                        ...
                        "allowedValues": {
                            "f0": {"mandatory": True, "allowedValues": "float"}
                        },
                    },
                    {
                        "name": "gaussian",
                        ...
                        "allowedValues": {
                            "f0": {"mandatory": True, "allowedValues": "float"},
                            "fc": {"mandatory": True, "allowedValues": "float"},
                        },
                    },
                    {
                        "name": "custom",
                    ...
                    },
                    {
                        ...
                        "allowedValues": {
                            "fm": {"mandatory": True, "allowedValues": "float"}
                        },
                    },
                    {
                        "name": "dirac",
                ...
                "items": [
                    {
                        ...
                        "mandatory": True,
                        "allowedValues": {
                            "R": {"mandatory": True, "allowedValues": "float"},
                            "RUnits": {
                                "mandatory": True,
                                "allowedValues": r"(uOhm|mOhm|Ohm|kOhm|MOhm|GOhm)",
                            },
                            "REnabled": {"mandatory": True, "allowedValues": "bool"},
                            "L": {"mandatory": True, "allowedValues": "float"},
                            "LUnits": {
                                "mandatory": True,
                                "allowedValues": r"(pH|uH|nH|mH|H|kH|MH|GH)",
                            },
                            "LEnabled": {"mandatory": True, "allowedValues": "bool"},
                            "C": {"mandatory": True, "allowedValues": "float"},
                            "CUnits": {
                                "mandatory": True,
                                "allowedValues": r"(pF|uF|nF|mF|F|kF|MF|GF)",
                            },
                            "CEnabled": {"mandatory": True, "allowedValues": "bool"},
                            "direction": {
                                "mandatory": True,
                                "allowedValues": r"(x|y|z)",
                            },
                            "capsEnabled": {"mandatory": True, "allowedValues": "bool"},
                            "combinationType": {
                                "mandatory": True,
            ...
            },
            {
                ...
                "mandatory": False,
                "items": [
                    {"name": "type", "mandatory": True, "allowedValues": "string"},
                    {"name": "parent", "mandatory": True, "allowedValues": "string"},
                    {
                        "name": "category",
                        "mandatory": True,
                        "allowedValues": r"(Material|Probe|Excitation|Port|Grid|LumpedPart)",
                    },
                    {"name": "freeCadId", "mandatory": True, "allowedValues": "string"},
                ],
            },
            {
                "name": r"SIMULATION-(.+)",
                "mandatory": True,
                "items": [
                    {"name": "name", "mandatory": True, "allowedValues": "string"},
                    {
                        "name": "params",
                        "mandatory": True,
                        "allowedValues": {
                            ...
                            "PMLxmincells": {"mandatory": True, "allowedValues": "int"},
                            "PMLxmaxcells": {"mandatory": True, "allowedValues": "int"},
                            "PMLymincells": {"mandatory": True, "allowedValues": "int"},
                            "PMLymaxcells": {"mandatory": True, "allowedValues": "int"},
                            "PMLzmincells": {"mandatory": True, "allowedValues": "int"},
                            "PMLzmaxcells": {"mandatory": True, "allowedValues": "int"},
                            "generateJustPreview": {
                                "mandatory": True,
                                "allowedValues": "bool",
                            },
            ...
            {"name": r"PRIORITYLIST-OBJECTS", "mandatory": True},
            {"name": r"PRIORITYLIST-MESH", "mandatory": True},
            {
    ...
    def checkFile(self, filepath):
                ...
                if re.match(iniSchemaGroup["name"], currentGroupName):
                    ...
                    if "items" in iniSchemaGroup.keys():
                        for iniGroupItem in iniSchemaGroup["items"]:
                            ...
                            isPresent = sum(
                                [
                                    bool(re.match(iniGroupItem["name"], key))
                                    for key in settings.childKeys()
                                ]
                            )
                            if isMandatory and not isPresent:
                                errorList.append(
                                    f"[{currentGroupName}] does not contains item '{iniGroupItem['name']}'"
                                )
                            ...
                            #
                            if isPresent and (
                                isMandatory or type(iniGroupItem["mandatory"]) == bool
                            ):
                                currentGroupItemValue = settings.value(
                                    iniGroupItem["name"]
                                )
                                errorType = False
                                if iniGroupItem["allowedValues"] == "string":
                                    ...
                                    if not re.match(
                                        r"(0|1|false|true)",
                                        str(currentGroupItemValue).lower(),
                                    ):
                                        errorType = True
                                    ...
                                    #
                                    try:
                                        currentGroupItemValue = json.loads(
                                            currentGroupItemValue
                                        )
                                    except Exception as e:
                                        print(
                                            f"[{currentGroupName}] -> '{iniGroupItem['name']}: ERROR json format: {e}"
                                        )
                                        continue

                                    for elementKey, elementDefinition in iniGroupItem[
                                        "allowedValues"
                                    ].items():
                                        isPresent = (
                                            elementKey in currentGroupItemValue.keys()
                                        )
                                        if isPresent:
                                            isMandatory = bool(
                                                eval(
                                                    str(elementDefinition["mandatory"])
                                                )
                                            )
                                            if (
                                                isMandatory
                                                or type(elementDefinition["mandatory"])
                                                == bool
                                            ):
                                                if (
                                                    elementDefinition["allowedValues"]
                                                    == "string"
                                                ):
                                                    pass
                                                elif (
                                                ...
                                                if errorType:
                                                    errorList.append(
                                                        f"[{currentGroupName}] -> '{iniGroupItem['name']}' -> {elementKey} has invalid value '{currentGroupItemValue[elementKey]}', expected '{elementDefinition['allowedValues']}'"
                                                    )
                                    ...
                                    try:
                                        currentGroupItemValue = (
                                            ",".join(currentGroupItemValue)
                                            if type(currentGroupItemValue) == list
                                            else currentGroupItemValue
                                        )
                                        if not re.match(
                                            iniGroupItem["allowedValues"],
                                            currentGroupItemValue,
                                        ):
                                            errorType = True
                                    except:
                                ...
                                if errorType:
                                    errorList.append(
                                        f"[{currentGroupName}] -> '{iniGroupItem['name']}' has invalid value '{currentGroupItemValue}', expected '{iniGroupItem['allowedValues']}'"
                                    )
        ...
        #
        for iniSchemaGroup in self.IniFileSchema["topLevelGroups"]:
            if "isPresent" not in iniSchemaGroup.keys() and iniSchemaGroup["mandatory"]:
                print(
                    f"FAIL - {iniSchemaGroup['name']} group is mandatory and not found"
                )
