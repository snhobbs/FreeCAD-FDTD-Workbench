...
class FreeCADHelpers(CadInterface):
    ...
    def selectObjectByLabel(self, objLabel):
        ...
        if freecadObj:
            FreeCADGui.Selection.addSelection(
                FreeCAD.ActiveDocument.Name, freecadObj[0].Name, ""
            )
    ...
    def drawDraftLine(self, lineName, p1Array, p2Array, gridLineStyle="Solid"):
        ...
        points = [
            FreeCAD.Vector(p1Array[0], p1Array[1], p1Array[2]),
            FreeCAD.Vector(p2Array[0], p2Array[1], p2Array[2]),
        ]

        line = Draft.makeWire(
            points, placement=pl, closed=False, face=False, support=None
        )
            ...
            if root.child(i).text(0) == "Material" or root.child(i).text(0) == "Grid":
                ...
                for j in range(child_count2):
                    ...
                    for k in range(child_count3):
                        ...
                        freeCadObj = FreeCAD.ActiveDocument.getObjectsByLabel(
                            freeCadObjName
                        )
